    ...
    <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-4 py-8">
        <div class="inline-flex">
            <a href="#" class="inline-flex flex-row items-center">
                ...
                <span class="leading-10 text-gray-800 text-4xl font-bold ml-1 uppercase">BrandName</span>
            </a>
        </div>
            ...
            <form action="<?=ROOT_URL?>auth/register.php" enctype="multipart/form-data" method="post">
                <div class="flex flex-col mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input id="name" type="text" name="name" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-indigo-400" placeholder="Name" />
                    </div>
                </div>
                <div class="flex flex-col mb-4">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input id="password_confirmation" type="password" name="password_confirmation" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-indigo-400" placeholder="Confirm Password" />
                    </div>
                </div>
                <div class="flex flex-col mb-4">
                    <label for="password_confirmation" class="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">Profile:</label>
                    <div class="relative">
                        <div class="inline-flex items-center justify-center absolute left-0 top-0 h-full w-10 text-gray-400">
                            <span>
                                <svg class="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <input id="avatar" type="file" name="avatar" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-indigo-400" />
                    </div>
                </div>

                <div class="flex w-full mt-6">
                    <button type="submit" name="submit" class="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-indigo-600 hover:bg-indigo-700 rounded py-2 w-full transition duration-150 ease-in">
        ...
        <div class="flex justify-center items-center mt-6">
            <a href="signin.php" class="inline-flex items-center font-bold text-indigo-500 hover:text-indigo-700 text-sm text-center">
                <span>
                    <svg class="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
